...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Perform ADC quad-core calibration")
	parser.add_argument("-l", "--log-file", dest="log", metavar="FILE", type=str, default=None,
	  help="write log messages to FILE in addition to stdout (default is $HOME/log/adc_quad_core_cal_HOST.log")
	parser.add_argument("-v", "--verbose", action="store_true", default=False,
	  help="set logging to level DEBUG")
	parser.add_argument("r2dbe_host", metavar="HOST", type=str,
	  help="perform calibration for HOST")
